...
new WPUpdatesThemeUpdater_1932( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1932') ) {
    class WPUpdatesThemeUpdater_1932 {
