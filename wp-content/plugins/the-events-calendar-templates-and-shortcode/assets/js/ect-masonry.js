          ...
          tempWrapper.find(".ect-categories li").click(function(e) {
              ...
              self.masonryFilter({
                  filter: function () {
                      ...
                      return contents.includes(filter);
                  }
              });
          });
        ...
        jQuery.post(ajaxUrl, data, function(response) {
          ...
          if (rs.events == "yes") {
              setTimeout(function() {
                  ...
                  var $masonryContainer = tempWrapper.find('.ect-masonary-cont');
                  var currentScrollTop = $(window).scrollTop();
                  // Destroy Masonry before adding new items
