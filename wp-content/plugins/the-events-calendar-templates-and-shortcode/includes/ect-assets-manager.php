...
class Ect_Assets_Manager {
	...
	function ect_register_assets() {
		wp_register_style( 'ect-common-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-common-styles.css', null, ECT_PRO_VERSION, 'all' );
		...
		wp_register_script( 'ect-apply-filterbar-js', ECT_PRO_PLUGIN_URL . 'assets/js/ect-apply-filterbar.js', array( 'jquery' ), ECT_PRO_VERSION, true );
	...
	public static function ect_load_requried_assets( $template, $style, $slider_pp_id, $autoplay, $carousel_slide_show ) {
		...
		wp_enqueue_style( 'ect-common-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-common-styles.css', null, ECT_PRO_VERSION, 'all' );
		wp_enqueue_script( 'ect-common-scripts', ECT_PRO_PLUGIN_URL . 'assets/js/ect.js', array( 'jquery' ), ECT_PRO_VERSION, true );
		wp_enqueue_script( 'ect-apply-filterbar-js', ECT_PRO_PLUGIN_URL . 'assets/js/ect-apply-filterbar.js', array( 'jquery' ), ECT_PRO_VERSION, true );
		...
		/*** Highlighted Layout styles/scripts */
		elseif ( $template == 'highlighted-layout' ) { 
			wp_enqueue_style( 'ect-highlighted-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-highlighted-layout.css', null, ECT_PRO_VERSION, 'all' );
			wp_enqueue_script( 'ect-highlighted-js', ECT_PRO_PLUGIN_URL . 'assets/js/ect-highlighted-layout.js', array( 'jquery' ), ECT_PRO_VERSION, true );
			wp_add_inline_style( 'ect-highlighted-styles', $custom_style );
		}
	}
