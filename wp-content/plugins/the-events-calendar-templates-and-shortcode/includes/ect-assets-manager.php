...
class Ect_Assets_Manager
{
   ...
   function ect_register_assets() {
    wp_register_style('ect-common-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-common-styles.min.css',null,null,'all' );	
     wp_register_style('ect-timeline-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-timeline-view.css',null,null,'all' );	
     wp_register_style('ect-list-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-list-view.css',null,null,'all' );	
     wp_register_style('ect-grid-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-grid-view.css',null,null,'all' );
    wp_register_style('ect-carousel-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-carousel-view.css',null,null,'all' );
    wp_register_style('ect-slider-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-slider-view.css',null,null,'all' );
    wp_register_style('ect-accordion-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-accordion-view.css',null,null,'all' );
    wp_register_style('ect-minimal-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-minimal-list-view.min.css',null, null,'all' );
    wp_register_style('ect-cover-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-cover-view.css',null, null,'all' );
    ...
    wp_register_script('ect-accordion-js', ECT_PRO_PLUGIN_URL . 'assets/js/ect-accordion-view.min.js',array('jquery'),null,true);
    ...
    wp_register_script('ect-common-scripts',ECT_PRO_PLUGIN_URL .'assets/js/ect.js',array('jquery'),null,true);
