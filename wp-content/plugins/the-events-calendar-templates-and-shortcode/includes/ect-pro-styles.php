...
class EctProStyles
{
    ...
    */
    ...
    public  function ect_styles(){
        wp_register_style('ect-common-styles', ECT_PRO_PLUGIN_URL . 'assets/css/ect-common-styles.min.css',null, ECT_VERSION,'all' );	
    ...
    public static function ect_custom_styles($template,$style){
        ...
        $ect_output_css .='.ect-load-more a.ect-load-more-btn {
            ...
            .ect-rate-area span.ect-ticket-info a:hover {
                 color: '.Ecttinycolor($main_skin_alternate_color)->lighten(5)->toString().' !important;
            }
            span.tribe-tickets-left {
                color:  '.Ecttinycolor($main_skin_alternate_color)->darken(5)->toString().';
            }
            .ect-rate-area span.ect-ticket-info a {
                background: '.Ecttinycolor($main_skin_color)->darken(8)->toString().';
                background-image: linear-gradient(to right, '.Ecttinycolor($main_skin_color)->darken(8)->toString().' 0%, '.Ecttinycolor($main_skin_color)->lighten(-1)->toString().' 51%,'.Ecttinycolor($main_skin_color)->darken(8)->toString().' 100%);
                box-shadow: 3px 3px 10px -6px '.Ecttinycolor($main_skin_color)->darken(12)->toString().';
            }
            .ect-load-more:before,
			.ect-load-more:after {
				background: '.Ecttinycolor($main_skin_color)->lighten(20)->toString().';
			}
            div[id*="event-"] .ect-event-category ul.tribe_events_cat li a{
                color: '.$main_skin_alternate_color.';
                border-color: '.Ecttinycolor($main_skin_color)->darken(10)->toString().';
