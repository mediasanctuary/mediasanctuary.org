 ...
 */
     ...
     //   background: #000;
      //  border-color: #000;
        ...
        {
            $screen_id = isset($_REQUEST['post_type'])?$_REQUEST['post_type']:'';
            $get_elemntor_page = isset($_REQUEST['action'])?$_REQUEST['action']:'';
                ...
                ECTCSF::createSection($prefix, array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'default' => '2',
                            'dependency' => array(
                                'template', 'any', 'grid-view,masonry-view,carousel-view',
                            ),
                            'options' => array(
                                '2' => '2',
                                '3' => '3',
                        ...
                        array(
                            ...
                            'default' => 'true',
                            'dependency' => array(
                                'template', 'any', 'slider-view,carousel-view,cover-view',
