...
function ect_pro_block_callback( $attr ) {
	...
	if ( isset( $template ) ) {
		...
		show-description="%s"
		 tags="%s" venues="%s" organizers="%s" socialshare="%s" date-lbl="%s" time-lbl="%s" event-lbl="%s" desc-lbl="%s" category-lbl="%s" location-lbl="%s" vm-lbl="%s" filterbar="%s" filterbarstyle="%s"]';
		$shortcode        = sprintf(
			$shortcode_string,
			$template,
			$style,
