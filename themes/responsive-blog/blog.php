...
<div id="content-blog" class="responsive_blog_full_posts_page <?php echo esc_attr( implode( ' ', responsive_get_content_classes() ) ); ?>">
...
<?php the_post_thumbnail(); ?>
		...
		if ( $wp_query->max_num_pages > 1 ) :
			...
			<div class="navigation">
				<div class="previous"><?php next_posts_link( __( '<img src="'.get_stylesheet_directory_uri().'/images/arrows_archive_prev.png" />' ), $wp_query->max_num_pages ); ?></div>
