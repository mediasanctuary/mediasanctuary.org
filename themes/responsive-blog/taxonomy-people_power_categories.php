...
/**
 * Archive Template for peoplepower custom taxonomy
 *
 *
 * @file           taxonomy-people_power_categories.php
 * @package        Responsive
 * @author         RM
 * @license        license.txt
 * @version        Release: 1.1
...
<div id="content-archive" class="responsive_blog_archive_page ppcat <?php echo esc_attr( implode( ' ', responsive_get_content_classes() ) ); ?>">
