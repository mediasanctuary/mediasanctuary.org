...
<div class="tribe-events-pro-week-grid__event-tooltip-datetime">
	<?php $this->template( 'widget-week/grid-body/events-day/event/tooltip/date/featured' ); ?>
	<time datetime="<?php echo esc_attr( $event_date_attr ); ?>">
		<?php echo $event->schedule_details->value(); ?>
	</time>
	<?php $this->template( 'widget-week/grid-body/events-day/event/tooltip/date/recurring', [ 'event' => $event ] ); ?>
</div>
