...
<div class="tribe-events-pro-week-mobile-events__event-datetime-wrapper tribe-common-b2">
	<?php $this->template( 'widget-week/mobile-events/day/event/date/featured', [ 'event' => $event ] ); ?>
	<time
	...
	<?php $this->template( 'widget-week/mobile-events/day/event/date/recurring', [ 'event' => $event ] ); ?>
</div>
