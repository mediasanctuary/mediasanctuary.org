...
>
	...
	>
		<div class="tribe-events-pro-week-grid__event-link-inner">
			...
			<?php $this->template( 'widget-week/grid-body/events-day/event/featured-image', [ 'event' => $event ] ); ?>
			<?php $this->template( 'widget-week/grid-body/events-day/event/date', [ 'event' => $event ] ); ?>
			<?php $this->template( 'widget-week/grid-body/events-day/event/title', [ 'event' => $event ] ); ?>

		</div>
	</a>
</article>

<?php $this->template( 'widget-week/grid-body/events-day/event/tooltip', [ 'event' => $event ] ); ?>
