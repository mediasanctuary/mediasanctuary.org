...
>
	<?php $this->template( 'widget-week/grid-body/multiday-events-day/multiday-event/hidden/link/featured', [ 'event' => $event ] ); ?>
	<?php $this->template( 'widget-week/grid-body/multiday-events-day/multiday-event/hidden/link/title', [ 'event' => $event ] ); ?>
	<?php $this->template( 'widget-week/grid-body/multiday-events-day/multiday-event/hidden/link/recurring', [ 'event' => $event ] ); ?>
</a>
