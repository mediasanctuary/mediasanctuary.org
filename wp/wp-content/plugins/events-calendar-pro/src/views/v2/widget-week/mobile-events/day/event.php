...
<article <?php tribe_classes( $classes ) ?>>
	...
	<?php $this->template( 'widget-week/mobile-events/day/event/featured-image', [ 'event' => $event ] ); ?>

	<div class="tribe-events-pro-week-mobile-events__event-details tribe-common-g-col">

		<?php $this->template( 'widget-week/mobile-events/day/event/date', [ 'event' => $event ] ); ?>
		<?php $this->template( 'widget-week/mobile-events/day/event/title', [ 'event' => $event ] ); ?>
		<?php $this->template( 'widget-week/mobile-events/day/event/venue', [ 'event' => $event ] ); ?>
		<?php $this->template( 'widget-week/mobile-events/day/event/cost', [ 'event' => $event ] ); ?>
