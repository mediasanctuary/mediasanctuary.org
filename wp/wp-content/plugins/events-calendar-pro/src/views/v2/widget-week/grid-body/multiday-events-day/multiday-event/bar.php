...
<div class="tribe-events-pro-week-grid__multiday-event-bar">
	<div class="tribe-events-pro-week-grid__multiday-event-bar-inner">
		<?php $this->template( 'widget-week/grid-body/multiday-events-day/multiday-event/bar/featured', [ 'event' => $event ] ); ?>
		<?php $this->template( 'widget-week/grid-body/multiday-events-day/multiday-event/bar/title', [ 'event' => $event ] ); ?>
		<?php $this->template( 'widget-week/grid-body/multiday-events-day/multiday-event/bar/recurring', [ 'event' => $event ] ); ?>
	</div>
</div>
